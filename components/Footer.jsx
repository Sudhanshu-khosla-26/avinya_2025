    ...
    const socialLinks = [
        {
            name: 'Instagram',
            icon: Instagram,
            url: 'https://www.instagram.com/the_empirical_society/',
            color: 'hover:text-pink-500'
        },
        {
            name: 'LinkedIn',
            icon: Linkedin,
            url: 'https://www.linkedin.com/company/the-empirical-society/',
            color: 'hover:text-blue-500'
        },
        {
            name: 'Mail',
            icon: Mail,
            url: 'https://mail.google.com/mail/?view=cm&fs=1&to=societytheempirical@gmail.com',
