        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <div className="relative flex flex-col items-center">
                ...
                <div className="w-64 h-1 bg-slate-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-purple-500 to-pink-500 animate-loading-bar rounded-full"></div>
                </div>

                {/* Tech details */}
                <div className="mt-6 flex gap-4 text-xs text-purple-300 font-mono">
                    <span className="animate-pulse">Neural Network</span>
                    <span className="animate-pulse" style={{ animationDelay: '0.2s' }}>AI Core</span>
                    <span className="animate-pulse" style={{ animationDelay: '0.4s' }}>Systems Online</span>
                </div>
            </div>
