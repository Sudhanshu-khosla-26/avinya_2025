...
const EventCard = ({ title, description, timing, venue, imageUrl, RegistrationLink }) => {
    return (
        <div
            tabIndex={0}
            className="flip-card-container relative h-[300px] sm:h-80 md:h-[21.5rem] w-full max-w-[240px] sm:max-w-[280px] mx-auto perspective-1000 group outline-none"
        >
            ...
            {/* Inner Card */}
            <div className="flip-card-inner-container relative w-full h-full transition-transform duration-500 [transition-timing-function:cubic-bezier(0.77,0,0.175,1)] transform-style-3d [will-change:transform] group-hover:rotate-y-180 group-focus-within:rotate-y-180 active:rotate-y-180">
                {/* Front */}
